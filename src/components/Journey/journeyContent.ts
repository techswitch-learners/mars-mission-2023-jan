...
export function journeyContent(){
    ...
    const contentArray: Array<any> = [
        {text: stage1, img: "../../../../images/journeyImages/1-curiostiy-diagram.jpg"},
        {text: stage2, img: "../../../../images/journeyImages/2-curiostiy-rocket-launch.jpg"},
        {text: stage3, img: "../../../../images/journeyImages/3-earth-mars-journey.jpg"},
        {text: stage4, img: "../../../../images/journeyImages/4-curiostiy-landing.jpg"},
        {text: stage5, img: "../../../../images/journeyImages/5-curiostiy-first-image.jpg"}
    ]
    return contentArray;
}
